...
import de.leou.util.UtilsString;

public class Bean_logi_EDA_xls {
	...
	public Bean_logi_EDA_xls() {
		// TODO Auto-generated constructor stub
	}

	public Bean_logi_EDA_xls(Bean_PM_order o) {
		...
		this.H = UtilsString.delSuffix(this.H, ",");
		...
		this.I = UtilsString.delSuffix(this.I, ",");

		//packstation! 
		if (this.I.toUpperCase().contains("PACKSTATION")) {
			this.J= o.getDeliveryAddress_postident();
		} else {
			this.J = o.getDeliveryAddress_address3() + "," + o.getDeliveryAddress_address4();
			this.J = UtilsString.delSuffix(this.J, ",");
		}
